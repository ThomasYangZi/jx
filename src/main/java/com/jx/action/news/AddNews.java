...
public class AddNews extends HttpServlet{
    ...
    private void writeToNews(String fieldName, String value) {
        ...
        if(fieldName.equals("jxid")){
            int i = Integer.parseInt(value);
            news.setIdjx(i);
        }else if(fieldName.equals("jxname")){
            news.setJxname(value);
        }else if(fieldName.equals("jxpeoplenum")){
            int i = Integer.parseInt(value);
            news.setJxpeoplenum(i);
        }else if(fieldName.equals("jxplace")){
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        req.getRequestDispatcher("/WEB-INF/view/backstage/addjx.jsp").forward(req,resp);
    }
}
